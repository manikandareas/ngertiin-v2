...
export const apiEnvSchema = infrastructureEnvSchema
  .extend({
    ...
    CHAT_OUTPUT_MAX_TOKENS: z.coerce.number().int().positive().default(8192),
    CHAT_RUN_TIMEOUT_MS: z.coerce.number().int().positive().default(240000),
    CHAT_PROVIDER_TIMEOUT_MS: z.coerce.number().int().positive().default(180000),
