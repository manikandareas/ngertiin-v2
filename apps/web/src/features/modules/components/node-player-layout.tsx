  ...
  return (
    <div className="fixed inset-0 flex h-dvh overflow-hidden bg-background">
      <div className="@container/node-player flex min-h-0 min-w-0 flex-1 flex-col overflow-y-auto overscroll-contain bg-background px-6 text-foreground sm:px-10 lg:px-12">
        ...
        <div className="node-compact:grid-cols-[2.5rem_minmax(0,1fr)] node-compact:gap-x-4 mx-auto grid w-full max-w-7xl flex-1 items-start gap-8 md:grid-cols-[minmax(0,1fr)_minmax(0,2fr)] md:gap-12 md:pt-10 lg:gap-24 lg:pt-16">
          <NodePlayerSidebar
            title={title}
